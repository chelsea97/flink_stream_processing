...
import com.atguigu.keyTest.StudentInfo;
...
public class StreamingJobTest {
    public static void main(String[] args) throws Exception {
        ...
        //TypeInformation被用于处理序列化信息，指定了这些，表示自定义类型，自定义typeinfo之后，flink可以对这些类型序列化了
        //Type class -> String.class TypeInformation --> Types.String
        TypeInformation<StudentInfo> of = TypeInformation.of(StudentInfo.class);
        TypeInformation<Tuple2<String, Integer>> of1 = TypeInformation.of(new TypeHint<Tuple2<String, Integer>>() {
            @Override
